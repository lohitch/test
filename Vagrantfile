...
Vagrant.configure(2) do |config|
   ...
   config.vm.define :'check_mk_server' do |d|

    d.vm.hostname = 'cmkserver'
    ...
    d.vm.provider :virtualbox do |v|
      ...
      v.customize [ 'modifyvm', :id, '--name', 'check_mk_server', '--memory', '1024', '--cpus', '1' ]
    end
